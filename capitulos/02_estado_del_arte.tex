...
\label{sec:EstadoDelArte}
    ...
    \label{sec:RaspberryPi}
        ...
        \label{sub:ModelosRaspberryPi}
            ...
            diferentes variaciones. En la siguiente tabla se detallan alguno de los detalles de estos
            modelos \ref{fig:ImagenModelosPi}\cite{raspberry_pi_wikipedia_en}:
    ...
    \label{sec:Arduino}
        ...
        \label{sub:ModelosArduino}
            ...
            En la siguiente tabla se especifican los modelos de entrada de Arduino junto con algunas de sus
            especificaciones de hardware \ref{fig:ImagenModelosArduino}\cite{arduino_compare}:
