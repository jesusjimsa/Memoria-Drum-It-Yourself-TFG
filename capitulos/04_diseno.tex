    ...
    \label{sec:DecisionesTomadas}
        ...
        \label{sub:LibreriaDeReproduccionDeSonido}
            ...
            \begin{itemize}
                ...
                \item
                libao\cite{libao}: Esta librería se usa en conjunto con mpg123 para reproducir el sonido de la batería.
                mpg123 es la encargada de descodificar el archivo mp3 que contiene el sonido, mientras que libao utiliza
                la información que obtiene mpg123 y manda la señal al sistema operativo para reproducir el audio.
            \end{itemize}
