...
\label{cha:Implementacion}
    ...
    \label{sec:Pads}
        ...
        \label{sub:ConstruccionPads}
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Imagen de los pad con agujeros pequeños para los cables
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

            Una vez hecho eso, se añade la gomaeva para proteger los sensores y dar una mayor sensación de "rebote" %% cambiar esta palabra
